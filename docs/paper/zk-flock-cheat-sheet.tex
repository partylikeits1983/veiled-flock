...
\large Flock-ZK: A Candidate Zero-Knowledge Extension for Batched BLAKE3}
...
output for each new input. The paper counts the protocol's oracle calls and
includes programming, collision, Merkle-sibling, and grinding-tail terms in its
final bound.
...
$Q_P$ & The protocol's oracle-query bound for one simulated proof and verification, including the analytic grinding cap. The registered value is 997,858. \\
$Q_T$ & The total oracle budget $Q_H+Q_P$ used in collision and Merkle-boundary terms. \\
...
$\varepsilon_{\rm ZK}$ & The complete classical-ROM distinguishing bound, including algebraic, programming, Merkle, collision, and grinding-tail terms. \\
...
\midrule
Zero knowledge & Complete registered bound: 118.499 bits at $Q_H=2^{64}$. & Difficulty of distinguishing an honest proof from a simulated proof in the classical programmable ROM. \\
